...
public viewMenu = new EventEmitter<any>();
  ...
  public login(requestLogin: RequestLogin): Observable<ResponseLogin> {
    return this.httpClient.post<ResponseLogin>('https://localhost:5001/api/user/authenticate', requestLogin)
  }
  ...
  // login() {
  //   return this.httpClient.post<>('https://localhost:5001/api/user/authenticate');
  // }
  public listUser() {
    return this.httpClient.get<ResponseGetAllUser[]>('https://localhost:5001/api/user/listUser',
      {
        headers: {
  ...
  public listUserId(requestGetUserId: RequestGetUserId) {
    return this.httpClient.get<ResponseGetUserId>('https://localhost:5001/api/user/',
      {
        headers: {
          authorization: `Bearer ${this.authenticated}`
        }
  ...
  public createUser(requestCreateUser: RequestCreateUser): Observable<ResponseCreateUser> {
    return this.httpClient.post<ResponseCreateUser>('https://localhost:5001/api/user/createUser',
      requestCreateUser, {
        headers: {
          authorization: `Bearer ${this.authenticated}`
        }
  ...
  public updateUser(requestUpdateUser: RequestUpdateUser): Observable<ResponseUpdateUser> {
    return this.httpClient.put<ResponseUpdateUser>('https://localhost:5001/api/user/updateUser', requestUpdateUser,
      {
        headers: {
          authorization: `Bearer ${this.authenticated}`
        }
  ...
  public deletetUser(requestDeleteUser: RequestDeleteUser) {
    console.log('https://localhost:5001/api/user/deleteUser' + requestDeleteUser)
    return this.httpClient.delete<ResponseDeleteUser>('https://localhost:5001/api/user/' + requestDeleteUser,
      {
        headers: {
          authorization: `Bearer ${this.authenticated}`
        }
  ...
  //   return this.httpClient.delete<ResponseDeleteUser>('https://localhost:5001/api/user/deleteUser', requestDeleteUser,
  //   {headers:{
  //     authorization: `Bearer ${this.authenticated}`}});
  // }
